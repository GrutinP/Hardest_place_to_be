...
[macro name="start_walk_bg"]
    ...
    [frame p="100%" x="-2560"]
    [endkeyframe]
    [image layer="0" page="fore" name="walk_bg_loop" storage="%image|bg_ame_michi_loop.jpg" folder="bgimage" x="0" y="0" width="5120" height="720" visible="true" time="%time|1000"]
    [xanim name="walk_bg_loop" keyframe="walk_bg_scroll" time="%time|16000" easing="linear" count="infinite" wait="false"]
[endmacro]
...
[macro name="show_ajisai_n"]
    [chara_show name="ajisai_n" layer="3" time="%time|500"]
[endmacro]

[macro name="show_ajisai_w"]
    [chara_show name="ajisai_w" layer="3" time="%time|500"]
[endmacro]
