...
私は家が遠いから あの占いが終わったら家を出るって決めててさ[p]
...
; アジサイ: 困り・通常・イー
[chara_part name="ajisai_n" eyebrow="komari" eye="normal" mouth="i" effect="none"]
#ajisai_n
...
; アジサイ: 通常・ジト目・むくれ
[chara_part name="ajisai_n" eyebrow="normal" eye="jito" mouth="mukure" effect="none"]
#ajisai_n
;[playse storage="TODO_voice_ajisai_bad01_07.ogg"]
でも ここは滅多に車 通らないし[p]

; アジサイ: 困り・通常・O
[chara_part name="ajisai_n" eyebrow="komari" eye="normal" mouth="o" effect="none"]
#ajisai_n
;[playse storage="TODO_voice_ajisai_bad01_08.ogg"]
なんだっけ？ トラック？[p]

; アジサイ: 怒り・目閉じ笑み・イー
[chara_part name="ajisai_n" eyebrow="okori" eye="toji_emi" mouth="i" effect="none"]
#ajisai_n
...
; 暗転
[chara_hide name="ajisai_n" time="200"]
...
「車に水を引っかけられて、犬に顔を踏まれて、傘が壊れるでしょう」[p]
